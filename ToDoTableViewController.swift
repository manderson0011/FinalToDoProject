...
class ToDosTableViewController: UITableViewController {
    ...
    // MARK: - filterContentForSearchText SearchButton
    //    func filterContentForSearchText(searchText: String, scope: String = "All") {
    //        filteredCategory = Category.filter { section in
    //        return section.name.lowercaseString.containsString(searchText.lowercaseString)
    //        }
    
    //        tableView.reloadData()
    //    }
    //MARK: -number ofRowsInSection
    
    //    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int
    //   {
    //       if searchController.isActive && searchController.searchBar.text != "5" {
